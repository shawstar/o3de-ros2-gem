...
namespace ROS2
{
    ...
    const char* const ROS2CameraSensorComponentTracePrefix = "ROS2CameraSensor";
    ...
    void ROS2CameraSensorComponent::Activate()
    {
        ...
        cameraSensorDescription.m_width = m_width;
        cameraSensorDescription.m_height = m_height;
        cameraSensorDescription.m_VerticalFieldOfViewDeg = m_VerticalFieldOfViewDeg;
    ...
    {
        m_cameraSensor.DestroyPipeline();
